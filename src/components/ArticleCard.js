  ...
  return (
    <div className="rounded-md shadow bg-gradient-to-b from-gray-100 to-gray-200 flex h-72">
      ...
      <div className="m-5 h-full">
        ...
        <h1 className="font-medium text-lg tracking-widest mb-5">
          {title}
        </h1>
        <p className="mb-6 text-lg">{previewText}</p>
        <Link to={"/articles/"+ slug} className="text-red-600">Read More</Link>
      </div>
    </div>
  )
}

...
const PodcastPage = ({data:{sanityPodcast:{title, description, links}}}) => {
  return (
    <Layout>
      ...
      <p className="text-xl my-14">{description} <a href="https://feeds.transistor.fm/more-to-the-story-with-dr-andy-miller">View All Episodes</a></p>
      ...
      <hr className="my-14 border-red-900 border-solid"></hr>
      <p className="text-xl my-14">Listen to an Archive of Captain's Corner <a href="https://feeds.transistor.fm/captains-corner-podcast-archives">View All Episodes</a></p>
